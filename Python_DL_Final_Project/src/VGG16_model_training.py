...
#callbacks
checkpoint = ModelCheckpoint(filepath='VGG16_best_weights.hdf5', save_best_only=True, save_weights_only=True)
...
plt.legend()
plt.savefig('VGG16_acc.png', format = 'png')
...
plt.legend()
plt.savefig('VGG16_loss.png', format = 'png')
