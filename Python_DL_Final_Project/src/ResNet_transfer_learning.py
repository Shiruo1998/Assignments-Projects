...
#load conv base of ResNet with weights pretrained on ImageNet
conv_base = ResNet50(weights='imagenet', include_top=False, input_shape=(112, 112, 3))
...
#callbacks
checkpoint = ModelCheckpoint(filepath='TFResNet50_best_weights.hdf5', save_best_only=True, save_weights_only=True)
...
plt.legend()
plt.savefig('TFResNet50_acc.png', format = 'png')
...
plt.legend()
plt.savefig('TFResNet50_loss.png', format = 'png')
